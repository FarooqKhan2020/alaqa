          ...
          >
            <div className="text-center mb-12">
              <span 
                ...
                style={{ 
                  color: "#FF4A5D",
                  backgroundColor: hoveredIndex === index ? "rgba(255, 74, 93, 0.1)" : "transparent",
              ...
              <div 
                ...
                style={{
                  background: hoveredIndex === index 
                    ? "linear-gradient(135deg, #FF4A5D 0%, #e6394a 50%, #c92a3a 100%)"
              ...
              <div className={`transition-all duration-500 ${item.imageSide === "right" ? "md:order-first" : ""}`}>
                <h3 
                  className={`text-4xl md:text-5xl font-bold mb-6 transition-all duration-300 ${
                    hoveredIndex === index ? "text-transparent bg-clip-text bg-gradient-to-r from-[#FF4A5D] to-[#e6394a]" : ""
                  }`}
                    ...
                    {item.services.map((service, idx) => (
                      ...
                      >
                        <div 
                          ...
                          style={{ 
                            backgroundColor: hoveredIndex === index ? "#FF4A5D" : "rgba(255, 74, 93, 0.1)",
                            color: hoveredIndex === index ? "white" : "#FF4A5D"
                          }}
                        >
                          <svg
                            className="w-4 h-4"
            ...
            {index < expertiseItems.length - 1 && (
              <div className="mt-20 flex justify-center">
                <div className="w-24 h-1 rounded-full" style={{ backgroundColor: "#FF4A5D", opacity: 0.3 }}></div>
              </div>
            )}
          </div>
        ))}
