        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
              Hire Dedicated <span style={{ color: "#FF4A5D" }}>Engineers</span>
            </h1>
                ...
                <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 p-8 border border-gray-100 cursor-pointer group">
                  ...
                  <div className="space-y-2 mb-6">
                    <div className="flex items-center text-sm text-gray-600">
                      <svg className="w-4 h-4 mr-2 text-[#FF4A5D]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex items-center text-[#FF4A5D] font-semibold group-hover:translate-x-2 transition-transform">
                    View Details
          ...
          <div className="grid md:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {[
              ...
              <div key={index} className="text-center">
                <div className="w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold text-white mx-auto mb-4" style={{ backgroundColor: "#FF4A5D" }}>
                  {item.step}
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">{item.title}</h3>
                <p className="text-gray-600">{item.description}</p>
