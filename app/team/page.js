...
export default function Team() {
  ...
  const departments = [
    { name: "Development", count: 25, color: "#FF4A5D" },
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
              Meet Our <span style={{ color: "#FF4A5D" }}>Expert Team</span>
            </h1>
            ...
            {teamMembers.map((member, index) => (
              <div key={index} className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 overflow-hidden border border-gray-100">
                ...
                <div className="p-6">
                  ...
                  <p className="text-sm font-semibold mb-3" style={{ color: "#FF4A5D" }}>{member.role}</p>
                  <p className="text-sm text-gray-600 leading-relaxed">{member.bio}</p>
                  <div className="mt-4 flex space-x-3">
                    <a href="#" className="text-gray-400 hover:text-[#FF4A5D] transition-colors">
